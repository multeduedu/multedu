...
const HELP_TEXT: Record<DigitIndex, string> = {
  1: "Dobrar o 1º dígito e colocar na caixa. Se o total for 10 ou mais, some +1 ao próximo dígito.",
  2: "Dobrar o 2º dígito e colocar na caixa. Se o total for 10 ou mais, some +1 ao próximo dígito.",
  3: "Dobrar o 3º dígito e colocar na caixa. Se o total for 10 ou mais, some +1 ao próximo dígito.",
  4: "Dobrar o 4º dígito e colocar na caixa. Se o total for 10 ou mais, some +1 ao próximo dígito.",
  5: "Dobrar o 5º dígito e colocar na caixa. Se o total for 10 ou mais, some +1.",
}
...
export default function MultiplicadorX2() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const correctAnswer = String(Number(selects.join("")) * 2)
      ...
      const questionKey = `x2_${selects.join("")}`
      ...
      if (userAnswerNormalized === correctAnswerNormalized) {
        ...
        Swal.fire({
          ...swalBase,
          title: "✅ Acertou!",
          html: `A multiplicação de <strong>${selects.join("")}</strong> × 2 é: <strong>${correctAnswer}</strong>`,
          icon: "success",
        ...
        Swal.fire({
          ...swalBase,
          title: "❌ Errou!",
          html: `Sua resposta (<strong>${userAnswer}</strong>) está incorreta.<br>O resultado correto de <strong>${selects.join("")}</strong> × 2 é: <strong>${correctAnswer}</strong>`,
          icon: "error",
  ...
  return (
    <div className="flex flex-col items-center">
      <h2 className="sr-only">Treino de multiplicação por 2</h2>
      ...
      <div className="w-full">
        ...
        <div className="w-full overflow-x-auto overflow-y-hidden [-webkit-overflow-scrolling:touch] mb-6">
          ...
          >
            ...
            <span className="ml-0.5 font-bold text-sm sm:text-xl" aria-label="multiplicado por 2">
              ×2
            </span>
          </div>
        </div>
