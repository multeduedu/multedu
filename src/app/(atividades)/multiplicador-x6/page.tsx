...
export const metadata: Metadata = {
  title: "Multiplicação por 6 (Trachtenberg) | Treino",
  description:
    "Treine multiplicação por 6 usando a metodologia Trachtenberg. Selecione dígitos, preencha o resultado e confira.",
      ...
      <main id="conteudo" className="mx-auto max-w-6xl px-2 sm:px-4 pb-10 pt-6">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_380px] items-start">
          <section
            ...
            aria-label="Treino de multiplicação por 6"
          >
            <MultiplicadorX6 />
          </section>
          ...
          >
            ...
            <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-[var(--color-border)]">
              <iframe
                ...
                src="https://www.youtube.com/embed/Mj1kefQltyU"
                title="Multiplicação por 6 - Metodologia Trachtenberg (YouTube)"
                loading="lazy"
