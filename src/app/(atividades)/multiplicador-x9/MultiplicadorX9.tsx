...
const HELP_TEXT: Record<DigitIndex, string> = {
  1: "Primeiro dígito: Subtraia de 10.",
  2: "Segundo dígito: Subtraia de 9 e adicione o vizinho à direita.",
  3: "Terceiro dígito: Subtraia de 9 e adicione o vizinho à direita.",
  4: "Quarto dígito: Subtraia de 9 e adicione o vizinho à direita.",
  5: "Quinto dígito: Subtraia 1 do vizinho à direita.",
}
...
export default function MultiplicadorX9() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const correctAnswer = String(Number(selects.join("")) * 9)
      ...
      const questionKey = `x9_${selects.join("")}`
      ...
      if (userAnswerNormalized === correctAnswerNormalized) {
        ...
        Swal.fire({
          ...swalBase,
          title: "✅ Acertou!",
          html: `A multiplicação de <strong>${selects.join("")}</strong> × 9 é: <strong>${correctAnswer}</strong>`,
          icon: "success",
        ...
        Swal.fire({
          ...swalBase,
          title: "❌ Errou!",
          html: `Sua resposta (<strong>${userAnswer}</strong>) está incorreta.<br>O resultado correto de <strong>${selects.join("")}</strong> × 9 é: <strong>${correctAnswer}</strong>`,
          icon: "error",
  ...
  return (
    <div className="flex flex-col items-center">
      <h2 className="sr-only">Treino de multiplicação por 9</h2>
      ...
      <div className="w-full">
        ...
        <div className="w-full overflow-x-auto overflow-y-hidden [-webkit-overflow-scrolling:touch] mb-6">
          ...
          >
            ...
            <span className="ml-0.5 font-bold text-sm sm:text-xl" aria-label="multiplicado por 9">
              ×9
            </span>
          </div>
        </div>
