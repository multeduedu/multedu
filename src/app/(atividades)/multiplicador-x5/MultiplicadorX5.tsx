...
const HELP_TEXT: Record<DigitIndex, string> = {
  1: "1º Dígito: Se for par o número é 0, se for ímpar o número é 5",
  2: "2º Dígito: Ímpar ou par? Se ímpar, some +5. Olhe para o vizinho à direita e pegue a metade do número.",
  3: "3º Dígito: Ímpar ou par? Se ímpar, some +5. Olhe para o vizinho à direita e pegue a metade do número. Se o total for maior que 9, some +1 ao próximo dígito.",
  4: "4º Dígito: Ímpar ou par? Se ímpar, some +5. Olhe para o vizinho à direita e pegue a metade do número. Se o total for maior que 9, some +1 ao próximo dígito.",
  5: "5º Dígito: Ímpar ou par? Se ímpar, some +5. Olhe para o vizinho à direita e pegue a metade do número. Se o total for maior que 9, some +1 ao próximo dígito.",
}
...
export default function MultiplicadorX5() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const correctAnswer = String(Number(selects.join("")) * 5)
      ...
      const questionKey = `x5_${selects.join("")}`
      ...
      if (userAnswerNormalized === correctAnswerNormalized) {
        ...
        Swal.fire({
          ...swalBase,
          title: "✅ Acertou!",
          html: `A multiplicação de <strong>${selects.join("")}</strong> × 5 é: <strong>${correctAnswer}</strong>`,
          icon: "success",
        ...
        Swal.fire({
          ...swalBase,
          title: "❌ Errou!",
          html: `Sua resposta (<strong>${userAnswer}</strong>) está incorreta.<br>O resultado correto de <strong>${selects.join("")}</strong> × 5 é: <strong>${correctAnswer}</strong>`,
          icon: "error",
  ...
  return (
    <div className="flex flex-col items-center">
      <h2 className="sr-only">Treino de multiplicação por 5</h2>
      ...
      <div className="w-full">
        ...
        <div className="w-full overflow-x-auto overflow-y-hidden [-webkit-overflow-scrolling:touch] mb-6">
          ...
          >
            ...
            <span className="ml-0.5 font-bold text-sm sm:text-xl" aria-label="multiplicado por 5">
              ×5
            </span>
          </div>
        </div>
