...
import MultiplicadorX7 from "./MultiplicadorX7"
import BackButton from "@/components/ui/BackButton"

const indie = Indie_Flower({ subsets: ["latin"], weight: "400" })

export const metadata: Metadata = {
  title: "Multiplicação por 7 (Trachtenberg) | Treino",
  description:
    "Treine multiplicação por 7 usando a metodologia Trachtenberg. Selecione dígitos, preencha o resultado e confira.",
    ...
    <div className="min-h-screen overflow-x-hidden bg-[var(--color-background)] text-[var(--color-text-primary)]">
      ...
      <main id="conteudo" className="mx-auto max-w-6xl px-2 sm:px-4 pb-10 pt-6">
        <h1
          ...
          style={{
            backgroundImage: "linear-gradient(to right, #20b2aa, #48d1cc)",
            WebkitBackgroundClip: "text",
            color: "transparent",
            textShadow: "1px 1px 2px var(--color-primary)",
          }}
        >
          Multiplicação por 7 – Metodologia Trachtenberg
        </h1>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_380px] items-start">
          <section
            ...
            aria-label="Treino de multiplicação por 7"
          >
            <MultiplicadorX7 />
          </section>
          ...
          >
            ...
            <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-[var(--color-border)]">
              <iframe
                ...
                src="https://www.youtube.com/embed/4uIW08M3xQU"
                title="Multiplicação por 7 - Metodologia Trachtenberg (YouTube)"
                loading="lazy"
